            ...
            <Container fluid className='mt-5'>
                <Row className='gap-4 mb-4'>
                    <Col className='d-flex Certi'>
                        ...
                        <h4 className='fs-5'>TECNÓLOGO EN PRODUCCION DE MULTIMEDIA</h4>
                    </Col>
                    <Col className='d-flex Certi'>
                        <img src={Calidad} className='Certificado' alt="" />
                        <h4 className='fs-5'>COMPLEMENTARIA VIRTUAL EN ENGLISH DOT WORKS 4 (INGLES)</h4>
                    </Col>
                    <Col className='d-flex Certi'>
                        <img src={Calidad} className='Certificado' alt="" />
                        <h4 className='fs-5'>CURSO ESPECIAL EN EJERCICIO DERECHOS FUNDAMENTALES EN EL TRABAJO</h4>
                    </Col>
                </Row>
                <Row>
                    <Col className='d-flex flex-column align-items-center Certi'>
                        <img src={Calidad} className='Certificado me-0' alt="" />
                        <h4 className='fs-5'>HABILIDADES SOCIOEMOCIONALES PARA EL EMPLEO DECENTE</h4>
                    </Col>
                </Row>
            </Container>
        </div>
